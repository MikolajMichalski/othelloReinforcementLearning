...
EPISODES = 1000
outputFilePath = "save/output-minmaxrand_2_enemy-lr_0_001-ep_min_0_05-replay_b_500-batch_size_30-32_hidden_neurons.txt"
...
if __name__ == "__main__":
    ...
    max_reward = 0
    weights_to_load = \
        "save/trained-minmaxrand_2_enemy-lr_0_001-ep_min_0_05-replay_b_500-batch_size_30-32_hidden_neurons.h5"
        ...
        while True:
            ...
            if done:  ### IF DONE ADD THE FINAL REWARD OF THE EPISODE TO TOTAL_REWARD AND INCREMENT FULL_EPISODES_COUNTER
                ...
                if reward > 0:
                    ...
                    test_score = play_n_episodes(state, 20, False, True, 0, agent.epsilon)
                    if test_score > 80:
                ...
                #         agent.target_model.save(weights_to_load)
                #         test_score = play_n_episodes(state, 50, False, True, 0, agent.epsilon)
                #         if test_score > 90:
                #             print("Solved! Iterations played: {}, full episodes played: {}".format(iter_no,
                #                                                                                    full_episodes_counter))
                #             writeStdOutputToFile(outputFilePath,
